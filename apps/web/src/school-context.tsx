...
type View = "overview" | "students" | "parents" | "staff" | "classes" | "years" | "positions" | "settings" | "leave-review" | "finance" | "finance-reports";
...
const pages: View[] = ["overview", "students", "parents", "staff", "classes", "years", "positions", "settings", "leave-review", "finance", "finance-reports"];
