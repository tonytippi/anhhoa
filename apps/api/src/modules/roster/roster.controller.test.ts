...
describe('RosterController mutation boundary', () => {
  ...
  const roster = { createSchoolYear: vi.fn(), createClass: vi.fn(), renameClass: vi.fn(), archiveClass: vi.fn(), createStudent: vi.fn(), changeLifecycle: vi.fn(), createStaff: vi.fn(), updateStaff: vi.fn(), createPosition: vi.fn(), renamePosition: vi.fn(), inactivatePosition: vi.fn(), grantPositionCapability: vi.fn(), revokePositionCapability: vi.fn(), positions: vi.fn(), createAssignment: vi.fn(), changeAssignment: vi.fn(), endAssignment: vi.fn(), transitionEnrollments: vi.fn(), closeYear: vi.fn(), previewTransition: vi.fn(), previewCloseYear: vi.fn(), schoolYears: vi.fn(), classes: vi.fn(), students: vi.fn(), student: vi.fn(), staff: vi.fn(), assignments: vi.fn() };
