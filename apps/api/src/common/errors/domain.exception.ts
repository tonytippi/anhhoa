...
export const INVOICE_TEMPLATE_EMPTY = 'INVOICE_TEMPLATE_EMPTY';
export const INVOICE_BATCH_EMPTY = 'INVOICE_BATCH_EMPTY';

export class DomainException extends HttpException {
  constructor(code: typeof CLASS_HAS_ACTIVE_STUDENTS | typeof CLASS_ARCHIVED | typeof CLASS_NOT_FOUND | typeof IDEMPOTENCY_CONFLICT | typeof CLASS_TRANSFER_INVALID | typeof INVOICE_TEMPLATE_EMPTY | typeof INVOICE_BATCH_EMPTY, message: string, metadata?: { activeStudentCount: number }, fieldErrors?: string[]) {
