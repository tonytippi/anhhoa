...
function ParentWorkspace({ contexts, onLogout }: { contexts: ParentContext[]; onLogout: () => void }) {
...
export function ParentShell() {
  ...
  return <ParentWorkspace contexts={session.schools} onLogout={() => void logout(() => setSession(undefined))} />;
}
